    ...
    def start(self):
        for epoch in range(self.num_epochs):
            ...
            if val_loss < self.best_loss:
                ...
                torch.save(state, "/home/yuanye/Moun/1_PROJECTS/1-Python_r/Steel_Defect_Defection_New/models/model.pth")
            else:
                state["best_loss"] = val_loss
                modelname = "/home/yuanye/Moun/1_PROJECTS/1-Python_r/Steel_Defect_Defection_New/models/model_" + str(
                    epoch) + ".pth"
                torch.save(state, modelname)
            print()


sample_submission_path = "/home/yuanye/Moun/1_PROJECTS/1-Python_r/Steel_Defect_Defection_New/data/sample_submission.csv"
